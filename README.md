...
Pixel-accurate theme building, app-widget styling, and product-copy operations — most driven by Figma designs.
...
- **[figma-shopify-composer](./personal/shopify/figma-shopify-composer/SKILL.md)** — Recreate a Figma design by composing the theme's existing sections, blocks, and settings — template JSON only, no new code, every value traced to a design spec extracted from the frames.
