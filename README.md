...
- **[shopify-app-style-override-from-figma](./personal/shopify/shopify-app-style-override-from-figma/SKILL.md)** — Restyle a third-party app's widget to match a Figma design with CSS overrides only, without touching the app's code or HTML.
